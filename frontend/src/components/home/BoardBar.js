  ...
  return (
    <View style={styles.barContainer}>
      <TouchableOpacity
        ...
        onPress={() => { Object.keys(userData).length === 0 ? navigation.navigate('LoginNav', {screen: 'LoginNav'}) : [setOpt1Selected(), posting(1)]}}>
      ...
      <TouchableOpacity
        ...
        r
        disabled={board.userVote > 0}
        onPress={() => { Object.keys(userData).length === 0 ? navigation.navigate('LoginNav', {screen: 'LoginNav'}) : [setOpt2Selected(), posting(2)]}}>
