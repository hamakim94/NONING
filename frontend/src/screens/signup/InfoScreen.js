          ...
          render={({field: {onChange, value}}) => (
            <View style={{flexDirection: 'row'}}>
              <TextInput
                style={emailStyle}
                blurOnSubmit={false}
                onFocus={() => setEmailStyle(styles.checkFocusInput)}
                onBlur={() => setEmailStyle(styles.checkBlurInput)}
                ...
                render={({field: {onChange, onBlur, value}}) => (
                  <View style={{flexDirection: 'row'}}>
                    <TextInput
                      ...
                      onFocus={() => setNameStyle(styles.focusInput)}
                      onBlur={() => setNameStyle(styles.blurInput)}
                      onChangeText={value => onChange(value.replace(blank, ''))}
                      value={value}
                      returnKeyType="next"
                    />
